...
public class BLCandleStickChartRenderer extends LineScatterCandleRadarRenderer {
...
public BLCandleStickChartRenderer(CandleDataProvider chart, ChartAnimator animator,
    ...
    for (int j = mXBounds.min; j <= mXBounds.range + mXBounds.min; j++) {
      ...
      if (showCandleBar) {
        ...
        if (open > close) { // decreasing
          ...
          mRenderPaint.setStrokeCap(Paint.Cap.SQUARE);
